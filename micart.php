	...
	<div class="container-fluid">
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 lado6">
			...
			<details>
			  ...
			  <p>AQUI VAN LAS TARJETAS QUE AGREGUES</p>
			</details>
			
			<details>
			  <summary>Direcciones utilizadas: </summary>
			  <p>AQUI VAN LAS DIRECCIONES QUE AGREGUES</p>
			</details>
			...
			<div class="historial">
				...
				<div class="list-group">
				  <div class="list-group-item">
				    <p>AQUI VA TU HISTORIAL DE PEDIDOS</p>
				  </div>
				</div>
		...
		<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 lado6">
			...
			<div class="pedidos">
				<div class="list-group">
				  <p>AQUI VA LO AGREGADO A TU CARRITO</p>
				</div>
			</div>

			<div class="opcompra">
				<input type="submit" name="" value="Comprar todo" class="colore hovertop"">
				<input type="submit" name="" value="Limpiar carrito" class="colorc hovertop">
			</div>
		</div>
	</div>
