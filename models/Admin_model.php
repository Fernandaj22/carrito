<?php 
	...
	{
		public function agregarProductoA($Categoria, $Producto, $Descripcion, $nombre_imagen, $Precio, $Cantidad ) {
			...
			if ($tipo_imagen == "image/jpeg" || $tipo_imagen == "image/jpg" || $tipo_imagen == "image/png" || $tipo_imagen == "image/gif" || $tipo_imagen == "JPG") {
				...
				$dataA = array('idCategoria'=> $Categoria, 'nombreProducto' => $Producto, 'descripcion' => $Descripcion, 'imagen' => $nombre_imagen, 'precio' => $Precio, 'cantidad' => $Cantidad);
