      ...
      <div class="container-fluid cont">
        <div class="informacion col-xs-12 col-md-12">
          <div class="col-xs-12 col-xs-12 col-md-7 datos">
            <!-- multistep form -->
              <form id="msform" class="col-xs-12 col-md-12">
                <div class="" id="dat1">
                  <h1 class="fs-title">Ingresa tus datos</h1>
                  <h3 class="fs-subtitle">Datos del cliente</h3>
                  <input type="text" class="col-xs-12 col-md-12" name="email" placeholder="Email" value="Correo del cliente"/>
                  <input type="text" class="col-xs-12  col-md-12" name="" value="Nombre del cliente">
                  ...
                  <a href="#" class="col-xs-12 col-md-6">Regresar al carrito</a>
                  ...
                  <div class="hidden" id="dat2">
                      ...
                      <div onclick="select(this.id);" id="env" class="col-xs-12 col-md-12"for="env">Envio Estandar<p>$70.00</p></div>
